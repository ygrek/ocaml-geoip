...
(* OASIS_START *)
(* DO NOT EDIT (digest: 93b59d53fb6fce1ef383d4190e7a3ba5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://ygrek.org.ua/p/ocaml-geoip/";
          bugreports = None;
          ...
          description =
            Some
              [
                 ...
                 OASISText.Para "See http://www.maxmind.com/ for more info.";
                 OASISText.Para "This library implements OCaml bindings."
              ];
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\156\228\157\1829\235G\251\024\207\143vF\199{;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
